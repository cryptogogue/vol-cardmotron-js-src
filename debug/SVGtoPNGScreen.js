...
//================================================================//
// SVGtoPNGScreenController
//================================================================//
class SVGtoPNGScreenController {
...
// SVGtoPNGScreen
//================================================================//
export const SVGtoPNGScreen = observer (( props ) => {

    const controller = hooks.useFinalizable (() => new SVGtoPNGScreenController ( TEST_SVG, 900, 900, 300 ));

    return (
        <React.Fragment>

            <SingleColumnContainerView title = 'Test SVG to PNG'/>

            <If condition = { controller.dataURL !== false }>
                <center>
                    <div style = {{ width: '3in', height: '3in', backgroundColor: 'blue' }}>
                        <img
